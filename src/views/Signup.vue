        ...
        <div class="container">
          <div class="row">
            ...
            <div class="offset-xl-3 col-xl-6 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12 ">
              <div class="register-form">
                ...
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input v-model="user.password" id="password" type="password" name="password" placeholder="create password" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label sr-only" for="password"></label>
                    <input v-model="user.repeat_password" id="repeat-password" type="password" name="password" placeholder="confirm password" class="form-control" required>
                  </div>
                  <span>
              ...
              <p class="text-white">Already have an account?<router-link to="/login" class="text-yellow"> Log in</router-link> <span class="pull-right"><router-link to="/" class="text-white">Back to Home</router-link></span> </p>
            </div>
            <!-- /.register-form -->
          </div>
        </div>
